...
public void upDateDB()
    {
        ...
        try {
            ps = geneadmin.connect.getConnection().prepareStatement("SELECT * FROM feedback_tb");
            rs = ps.executeQuery();
            ...
            DefaultTableModel RecordTable = (DefaultTableModel)jTable1.getModel();
                    ...
                    while(rs.next())
                    {
                        ...
                        for(i = 1; i <= q; i++)
                        {
                            ...
                            columnData.add(rs.getString("user_text"));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("MANAGE FEEDBACK");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Username", "Feedback Given", "Date Updated"
            }
        ));
