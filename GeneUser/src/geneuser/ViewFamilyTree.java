 ...
 * @author Kaiserin
 */
public class ViewFamilyTree extends javax.swing.JFrame {
File f = null; 
String path = null;
...
private int selectedPosition;
    /**
     * Creates new form ViewFamilyTree
     */
    public ViewFamilyTree() {
        initComponents();
    ...
    try {
     ...
     ///////////
            String queryUserRelationFamilyType = "SELECT * FROM tree_tb WHERE position = ? AND tree = ?";
        try {
            ps = connect.getConnection().prepareStatement(queryUserRelationFamilyType);
            ps.setInt(1, 1);
            ps.setString(2, treetemp);
            rs = ps.executeQuery();

            if(rs.next()){
                labelrelation.setText(rs.getString("relationship"));
                labelfamilytype.setText("You");
            }else{
                JOptionPane.showMessageDialog(this, "Error");
            }
        } catch (SQLException ex) {
...
String querysearch = "SELECT * FROM tree_tb WHERE position = ? AND tree = ?"; 
    ...
    private void initComponents() {
        ...
        labelfamilytype = new javax.swing.JLabel();
        ...
        labelrelation.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        labelrelation.setText("Relationship");

        labelfamilytype.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        labelfamilytype.setText("Family Type");
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(labelrelation, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(labelfamilytype, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(53, 53, 53)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(labelfamilytype)
                        .addGap(187, 187, 187)))
                .addGap(324, 324, 324))
        );

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 1340, 650));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 1353, 20));
    ...
    private void SiblingLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SiblingLabel1MouseClicked
        ...
        try {
            ...
            if(rs.next()){
                labelrelation.setText(rs.getString("relationship"));
                labelfamilytype.setText("Sibling");
            }else{
                JOptionPane.showMessageDialog(this, "Error");
            }
        } catch (SQLException ex) {
    ...
    private void ParentsLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ParentsLabel1MouseClicked
        ...
        try {
            ...
            if(rs.next()){
                labelrelation.setText(rs.getString("relationship"));
                labelfamilytype.setText("Mother");
            }else{
                JOptionPane.showMessageDialog(this, "Error");
            }
        } catch (SQLException ex) {
    ...
    private void ParentsLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ParentsLabel2MouseClicked
        ...
        try {
            ...
            if(rs.next()){
                labelrelation.setText(rs.getString("relationship"));
                labelfamilytype.setText("Father");
            }else{
                JOptionPane.showMessageDialog(this, "Error");
            }
        } catch (SQLException ex) {
    ...
    private void GrandpaLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_GrandpaLabel1MouseClicked
        ...
        try {
            ...
            if(rs.next()){
                labelrelation.setText(rs.getString("relationship"));
                labelfamilytype.setText("Grandpa");
            }else{
                JOptionPane.showMessageDialog(this, "Error");
            }
        } catch (SQLException ex) {
    ...
    private void GranmaLabel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_GranmaLabel1MousePressed
        ...
        try {
            ...
            if(rs.next()){
                labelrelation.setText(rs.getString("relationship"));
                labelfamilytype.setText("Grandma");
            }else{
                JOptionPane.showMessageDialog(this, "Error");
            }
        } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewFamilyTree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewFamilyTree().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel labelfamilytype;
